...
export default function UserSidebar({
  ...
  return (
    <aside className="hidden flex-col border-b border-slate-200 bg-gradient-to-br from-[#0b132b] via-[#111f46] to-[#0c2446] px-6 py-6 text-slate-100 md:sticky md:top-0 md:flex md:h-screen md:w-80 md:shrink-0 md:border-b-0 md:border-r md:border-slate-800">
